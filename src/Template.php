 ...
 * instead, which returns an instance of \TwigKagg\TemplateWrapper.
 *
...
abstract class Template implements \TwigKagg_TemplateInterface
{
    ...
    public function displayBlock($name, array $context, array $blocks = [], $useBlocks = true)
    {
        ...
        if (null !== $template && !$template instanceof self) {
            throw new \LogicException('A block must be a method on a \TwigKagg\Template instance.');
        }
        ...
        if (null !== $template) {
            try {
                ...
                // this is mostly useful for \TwigKagg\Error\LoaderError exceptions
                // see \TwigKagg\Error\LoaderError
     ...
     * @param string $type              The type of attribute (@see \TwigKagg\Template constants)
    ...
    protected function getAttribute($object, $item, array $arguments = [], $type = self::ANY_CALL, $isDefinedTest = false, $ignoreStrictCheck = false)
    {
        ...
        // object property
        if (self::METHOD_CALL !== $type && !$object instanceof self) { // \TwigKagg\Template does not have public properties, and we don't want to allow access to internal ones
            if (isset($object->$item) || \array_key_exists((string) $item, (array) $object)) {
                if ($isDefinedTest) {
                    return true;
                }

                if ($this->env->hasExtension('\TwigKagg\Extension\SandboxExtension')) {
                    $this->env->getExtension('\TwigKagg\Extension\SandboxExtension')->checkPropertyAllowed($object, $item);
                }
        ...
        if ($this->env->hasExtension('\TwigKagg\Extension\SandboxExtension')) {
            $this->env->getExtension('\TwigKagg\Extension\SandboxExtension')->checkMethodAllowed($object, $method);
        }
