...
class Lexer implements \Twig_LexerInterface
{
    ...
    public function tokenize($code, $name = null)
    {
        if (!$code instanceof Source) {
            @trigger_error(sprintf('Passing a string as the $code argument of %s() is deprecated since version 1.27 and will be removed in 2.0. Pass a \TwigKagg\Source instance instead.', __METHOD__), E_USER_DEPRECATED);
