...
namespace TwigKagg\Profiler\Node;
...
class EnterProfileNode extends Node
{
    ...
    public function compile(Compiler $compiler)
    {
        $compiler
            ...
            ->raw(");\n")
            ->write(sprintf('$%s->enter($%s = new \TwigKagg\Profiler\Profile($this->getTemplateName(), ', $this->getAttribute('var_name'), $this->getAttribute('var_name').'_prof'))
