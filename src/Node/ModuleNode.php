...
{
    public function __construct(\TwigKagg_NodeInterface $body, AbstractExpression $parent = null, \TwigKagg_NodeInterface $blocks, \TwigKagg_NodeInterface $macros, \TwigKagg_NodeInterface $traits, $embeddedTemplates, $name, $source = '')
    {
        if (!$name instanceof Source) {
            @trigger_error(sprintf('Passing a string as the $name argument of %s() is deprecated since version 1.27. Pass a \TwigKagg\Source instance instead.', __METHOD__), E_USER_DEPRECATED);
    ...
    protected function compileClassHeader(Compiler $compiler)
    {
        ...
        if (!$this->getAttribute('index')) {
            $compiler
                ->write("use TwigKagg\Environment;\n")
                ->write("use TwigKagg\Error\LoaderError;\n")
                ->write("use TwigKagg\Error\RuntimeError;\n")
                ->write("use TwigKagg\Markup;\n")
                ->write("use TwigKagg\Sandbox\SecurityError;\n")
                ->write("use TwigKagg\Sandbox\SecurityNotAllowedTagError;\n")
                ->write("use TwigKagg\Sandbox\SecurityNotAllowedFilterError;\n")
                ->write("use TwigKagg\Sandbox\SecurityNotAllowedFunctionError;\n")
                ->write("use TwigKagg\Source;\n")
                ->write("use TwigKagg\Template;\n\n")
            ;
        }
        $compiler
...
class_alias('TwigKagg\Node\ModuleNode', 'TwigKagg_Node_Module');
