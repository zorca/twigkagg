...
use TwigKagg\Node\AutoEscapeNode;
...
use TwigKagg\Node\Expression\InlinePrint;
...
class EscaperNodeVisitor extends AbstractNodeVisitor
{
    ...
    protected function doEnterNode(Node $node, Environment $env)
    {
        if ($node instanceof ModuleNode) {
            if ($env->hasExtension('\TwigKagg\Extension\EscaperExtension') && $defaultStrategy = $env->getExtension('\TwigKagg\Extension\EscaperExtension')->getDefaultStrategy($node->getTemplateName())) {
