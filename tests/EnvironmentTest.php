...
use TwigKagg\Source;
use TwigKagg\Token;
use TwigKagg\TokenParser\AbstractTokenParser;
...
class EnvironmentTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testGlobals()
    {
        ...
        $loader = $this->createMock('\TwigKagg\Tests\EnvironmentTestLoaderInterface');
        //$loader = $this->createMock(['\TwigKagg\Loader\LoaderInterface', '\TwigKagg\Loader\SourceContextLoaderInterface']);
    ...
    public function testExtensionsAreNotInitializedWhenRenderingACompiledTemplate()
    {
        ...
        $twig = $this
            ->getMockBuilder('\TwigKagg\Environment')
    ...
    public function testAutoReloadCacheMiss()
    {
        ...
        $cache = $this->createMock('\TwigKagg\Cache\CacheInterface');
    ...
    public function testHasGetExtensionWithDynamicName()
    {
        ...
        $this->assertTrue($twig->hasExtension('TwigKagg\Tests\EnvironmentTest_Extension_DynamicWithDeprecatedName'));
    ...
    public function testHasGetExtensionByClassName()
    {
        ...
        $this->assertTrue($twig->hasExtension('TwigKagg\Tests\EnvironmentTest_Extension'));
        $this->assertTrue($twig->hasExtension('\TwigKagg\Tests\EnvironmentTest_Extension'));

        $this->assertSame($ext, $twig->getExtension('TwigKagg\Tests\EnvironmentTest_Extension'));
        $this->assertSame($ext, $twig->getExtension('\TwigKagg\Tests\EnvironmentTest_Extension'));

        $this->assertTrue($twig->hasExtension('TwigKagg\Tests\EnvironmentTest\Extension'));
        $this->assertSame($ext, $twig->getExtension('TwigKagg\Tests\EnvironmentTest\Extension'));
    }
    ...
    public function testAddExtensionWithDeprecatedGetGlobals()
    {
        ...
        $this->assertStringContainsString('Defining the getGlobals() method in the "TwigKagg\Tests\EnvironmentTest_Extension_WithGlobals" extension ', $this->deprecations[0]);
    ...
    public function testAddMockExtension()
    {
        ...
        // $extension = $this->createMock('\TwigKagg\Extension\AbstractExtension');
        $extension = eval(<<<EOF
use TwigKagg\Extension\AbstractExtension;
...
EOF
        ...
        $this->assertInstanceOf('\TwigKagg\Extension\ExtensionInterface', $twig->getExtension(\get_class($extension)));
    ...
    public function testInitRuntimeWithAnExtensionUsingInitRuntimeDeprecation()
    {
        ...
        $this->assertCount(1, $this->deprecations);
        $this->assertStringContainsString('Defining the initRuntime() method in the "TwigKagg\Tests\EnvironmentTest_ExtensionWithDeprecationInitRuntime" extension is deprecated since version 1.23.', $this->deprecations[0]);
    ...
    {
        $runtimeLoader = $this->createMock('\TwigKagg\RuntimeLoader\RuntimeLoaderInterface');
...
class_alias('\TwigKagg\Tests\EnvironmentTest_Extension', 'TwigKagg\Tests\EnvironmentTest\Extension', false);
...
class EnvironmentTest_ExtensionWithoutRuntime extends AbstractExtension
{
    ...
    {
        return [
            new TwigFunction('from_runtime_array', ['TwigKagg\Tests\EnvironmentTest_Runtime', 'fromRuntime']),
            new TwigFunction('from_runtime_string', 'TwigKagg\Tests\EnvironmentTest_Runtime::fromRuntime'),
        ];
    }
