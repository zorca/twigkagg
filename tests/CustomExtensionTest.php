...
class CustomExtensionTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        return [
            [new InvalidOperatorExtension(new \stdClass()), '"TwigKagg\Tests\InvalidOperatorExtension::getOperators()" must return an array with operators, got "stdClass".'],
            [new InvalidOperatorExtension([1, 2, 3]), '"TwigKagg\Tests\InvalidOperatorExtension::getOperators()" must return an array of 2 elements, got 3.'],
        ];
    }
}
