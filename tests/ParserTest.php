...
class ParserTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testUnknownTag()
    {
        ...
        $parser = new Parser(new Environment($this->createMock('\TwigKagg\Loader\LoaderInterface')));
        $parser->parse($stream);
    }
...
EOF
    ...
    {
        $parser = new TestParser(new Environment($this->createMock('\TwigKagg\Loader\LoaderInterface')));
...
class TestParser extends Parser
{
    ...
    public function filterBodyNodes(\TwigKagg_NodeInterface $node)
    {
