...
use TwigKagg\Sandbox\SecurityNotAllowedFilterError;
use TwigKagg\Sandbox\SecurityNotAllowedFunctionError;
use TwigKagg\Source;
use TwigKagg\Template;

/* foo.twig */
class __TwigTemplate_%x extends \TwigKagg\Template
{
...
EOF
        ...
        $twig = new Environment($this->createMock('\TwigKagg\Loader\LoaderInterface'), ['debug' => true]);
        $node = new ModuleNode($body, $extends, $blocks, $macros, $traits, new Node([]), $source);
        $tests[] = [$node, <<<EOF
<?php
