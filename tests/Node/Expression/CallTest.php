...
use TwigKagg\Node\Expression\CallExpression;
...
class CallTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testResolveArgumentsWithMissingParameterForArbitraryArguments()
    {
        ...
        $this->expectExceptionMessage('The last parameter of "TwigKagg\\Tests\\Node\\Expression\\CallTest::customFunctionWithArbitraryArguments" for function "foo" must be an array with default value, eg. "array $arg = []".');
    ...
    {
        $this->expectException('\LogicException');
        $this->expectExceptionMessageRegExp('#^The last parameter of "TwigKagg\\\\Tests\\\\Node\\\\Expression\\\\CallableTestClass\\:\\:__invoke" for function "foo" must be an array with default value, eg\\. "array \\$arg \\= \\[\\]"\\.$#');
