...
class NameTest extends NodeTestCase
{
    ...
    public function getTests()
    {
        ...
        $env = new Environment($this->createMock('\TwigKagg\Loader\LoaderInterface'), ['strict_variables' => true]);
        $env1 = new Environment($this->createMock('\TwigKagg\Loader\LoaderInterface'), ['strict_variables' => false]);
