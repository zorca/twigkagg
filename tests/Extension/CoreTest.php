...
class CoreTest extends \PHPUnit\Framework\TestCase
{
    ...
    public function testRandomFunctionWithoutParameter()
    {
        ...
        for ($i = 0; $i < 100; ++$i) {
            $val = twig_random(new Environment($this->createMock('\TwigKagg\Loader\LoaderInterface')));
    ...
    {
        $this->assertSame('', twig_random(new Environment($this->createMock('\TwigKagg\Loader\LoaderInterface')), ''));
        $this->assertSame('', twig_random(new Environment($this->createMock('\TwigKagg\Loader\LoaderInterface'), ['charset' => null]), ''));

        $instance = new \stdClass();
        $this->assertSame($instance, twig_random(new Environment($this->createMock('\TwigKagg\Loader\LoaderInterface')), $instance));
    }
    ...
    public function testRandomFunctionOfEmptyArrayThrowsException()
    {
        ...
        twig_random(new Environment($this->createMock('\TwigKagg\Loader\LoaderInterface')), []);
    }
    ...
    {
        $twig = new Environment($this->createMock('\TwigKagg\Loader\LoaderInterface'));
        $twig->getExtension('\TwigKagg\Extension\CoreExtension')->setEscaper('foo', '\TwigKagg\Tests\Extension\foo_escaper_for_test');
    ...
    public function testUnknownCustomEscaper()
    {
        ...
        twig_escape_filter(new Environment($this->createMock('\TwigKagg\Loader\LoaderInterface')), 'foo', 'bar');
    }
