...
namespace TwigKagg\Tests\Extension;
...
use TwigKagg\Extension\SandboxExtension;
use TwigKagg\Loader\ArrayLoader;
use TwigKagg\Sandbox\SecurityError;
use TwigKagg\Sandbox\SecurityPolicy;
...
class SandboxTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->expectException('\TwigKagg\Sandbox\SecurityError');
    ...
    public function testSandboxUnallowedMethodAccessor()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('\TwigKagg\Sandbox\SecurityNotAllowedMethodError', $e, 'Exception should be an instance of TwigKagg_Sandbox_SecurityNotAllowedMethodError');
            $this->assertEquals('TwigKagg\Tests\Extension\FooObject', $e->getClassName(), 'Exception should be raised on the "TwigKagg\Tests\Extension\FooObject" class');
    ...
    public function testSandboxUnallowedFilter()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('\TwigKagg\Sandbox\SecurityNotAllowedFilterError', $e, 'Exception should be an instance of TwigKagg_Sandbox_SecurityNotAllowedFilterError');
    ...
    public function testSandboxUnallowedTag()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('\TwigKagg\Sandbox\SecurityNotAllowedTagError', $e, 'Exception should be an instance of TwigKagg_Sandbox_SecurityNotAllowedTagError');
    ...
    public function testSandboxUnallowedProperty()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('\TwigKagg\Sandbox\SecurityNotAllowedPropertyError', $e, 'Exception should be an instance of TwigKagg_Sandbox_SecurityNotAllowedPropertyError');
            $this->assertEquals('TwigKagg\Tests\Extension\FooObject', $e->getClassName(), 'Exception should be raised on the "TwigKagg\Tests\Extension\FooObject" class');
    ...
    {
        $twig = $this->getEnvironment(true, [], ['index' => $template], [], ['upper'], ['TwigKagg\Tests\Extension\FooObject' => 'getAnotherFooObject'], [], ['random']);
        try {
    ...
    {
        $twig = $this->getEnvironment(true, [], ['index' => $template], ['set'], [], ['TwigKagg\Tests\Extension\FooObject' => ['foo', 'getAnotherFooObject']]);
    ...
    {
        $twig = $this->getEnvironment(true, [], self::$templates, [], [], ['TwigKagg\Tests\Extension\FooObject' => '__toString']);
        FooObject::reset();
    ...
    public function testSandboxUnallowedFunction()
    {
        ...
        try {
            ...
            $this->assertInstanceOf('\TwigKagg\Sandbox\SecurityNotAllowedFunctionError', $e, 'Exception should be an instance of TwigKagg_Sandbox_SecurityNotAllowedFunctionError');
    ...
    {
        $twig = $this->getEnvironment(true, [], self::$templates, [], [], ['TwigKagg\Tests\Extension\FooObject' => 'foo']);
        FooObject::reset();
    ...
    {
        $twig = $this->getEnvironment(true, [], self::$templates, [], [], [], ['TwigKagg\Tests\Extension\FooObject' => 'bar']);
    ...
    public function testSandboxAllowFunctionsCaseInsensitive()
    {
        foreach (['getfoobar', 'getFoobar', 'getFooBar'] as $name) {
            $twig = $this->getEnvironment(true, [], self::$templates, [], [], ['TwigKagg\Tests\Extension\FooObject' => $name]);
            FooObject::reset();
...
EOF
    ...
    public function testSandboxDisabledAfterIncludeFunctionError()
    {
        ...
        $this->assertFalse($twig->getExtension('\TwigKagg\Extension\SandboxExtension')->isSandboxed(), 'Sandboxed include() function call should not leave Sandbox enabled when an error occurs.');
    }
